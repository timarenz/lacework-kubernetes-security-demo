...
event_text = "Welcome to the Hops & DevOps in Zurich!"
tweet_text = "Hello from Hops&DevOps. Just enjoyed a fantastic presentation from @timarenz about Shift Left Security with #laceworks #devsecops #shiftleft"
